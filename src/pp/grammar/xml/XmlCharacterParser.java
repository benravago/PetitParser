 ...
 */
public class XmlCharacterParser extends PetitParser {
  ...
  private static final PetitParser ENTITY_HEX = pattern("xX")
  ...
  private static final PetitParser ENTITY_DIGIT = of('#')
  ...
  private static final PetitParser ENTITY = of('&')
